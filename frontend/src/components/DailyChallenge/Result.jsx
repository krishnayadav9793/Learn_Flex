    ...
    <div className="min-h-screen bg-gradient-to-br from-[#D6E6F4] via-[#EAF3FB] to-[#F7F9FC] flex items-center justify-center p-6">
      ...
      >
        ...
        >
          <button
            onClick={onRetry}
            className="w-full bg-[#0B2447] hover:bg-[#163a6b] active:scale-95 text-white font-bold text-sm py-4 rounded-2xl transition-all duration-200 flex items-center justify-center gap-2"
          ...
          <button
            ...
            className="w-full text-xs font-bold text-slate-400 hover:text-[#0B2447] transition-colors uppercase tracking-widest flex items-center justify-center gap-1.5 py-2"
          >
            <span>←</span>
